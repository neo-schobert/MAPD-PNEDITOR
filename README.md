...
Our initial implementation was slightly modified to allow for the modification of an arc's weight. This was not possible initially, so we had to add the setWeight methods in Network, Transition, and Arc to make this feasible with the interface provided here.

Everything else was adapted without much difficulty.
